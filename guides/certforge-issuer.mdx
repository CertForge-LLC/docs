...
```bash
helm upgrade --install certforge-issuer oci://ghcr.io/certforge/charts/certforge-issuer \
...
image:
  repository: ghcr.io/certforge/certforge-issuer
...
```bash
helm upgrade certforge-issuer oci://ghcr.io/certforge/charts/certforge-issuer \
  --namespace certforge-system \
  --reuse-values
```
