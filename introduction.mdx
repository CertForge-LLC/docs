...
- **Reports** — built-in reports for certificate inventory, expiring certs, service cert expiry (by service owner), service coverage, and approval activity; subscribe to scheduled email delivery from your profile
