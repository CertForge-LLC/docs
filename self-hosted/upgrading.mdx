---
title: "Upgrading"
description: "Upgrade CertForge Self-Hosted to a new version safely — back up data, swap the binary, run schema migrations automatically, and roll back if needed."
---
