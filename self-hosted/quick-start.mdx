---
title: "Quick Start"
description: "Get a single-node CertForge Self-Hosted instance running in under 10 minutes using file-based storage — no database or external dependencies needed."
---
